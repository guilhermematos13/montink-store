...
export const productCardStyles = tv({
  slots: {
    buttonContainer:
      'flex max-w-[18rem] cursor-pointer flex-col gap-4 rounded-md border border-black bg-white p-4 transition-transform duration-300 ease-in-out hover:scale-105',
